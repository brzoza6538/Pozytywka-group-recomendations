...
class GroupReccomendations:
    ...
    def get_weighed_tracks(self, user_id):
        ...
        '''
        started_tracks = get_type_of_tracks(user_id, "play", self._time_window_start, self._time_window_end)
        skipped_tracks = get_type_of_tracks(user_id, "skip", self._time_window_start, self._time_window_end)
        liked_tracks = get_type_of_tracks(user_id, "like", self._time_window_start, self._time_window_end)
    ...
    def test_create_recommendations(self):
        ...
        constraints = list(itertools.product(time_start, time_end, users_favourite_tracks_amount_p, cluster_recommendation_p, taste_groups_p))
        results = []
